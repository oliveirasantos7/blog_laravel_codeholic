            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                    ...
                    @else
                        ...
                        <a href="{{ $paginator->previousPageUrl() }}" rel="prev" class="h-10 w-10 font-semibold text-gray-800 hover:text-gray-900 text-sm flex items-center justify-center ml-3" aria-label="{{ __('pagination.next') }}">
                            Prev <i class="fas fa-arrow-left ml-2"></i>
                        </a>
                    @endif
